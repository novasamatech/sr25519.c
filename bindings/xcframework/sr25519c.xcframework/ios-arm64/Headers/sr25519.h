...
static const unsigned long SR25519_CHAINCODE_SIZE = 32;

/// Size of SR25519 KEYPAIR. [32 bytes key | 32 bytes nonce | 32 bytes public]
static const unsigned long SR25519_KEYPAIR_SIZE = 96;

/// Size of SR25519 PUBLIC KEY, bytes
static const unsigned long SR25519_PUBLIC_SIZE = 32;

/// Size of SR25519 PRIVATE (SECRET) KEY, which consists of [32 bytes key | 32 bytes nonce]
static const unsigned long SR25519_SECRET_SIZE = 64;

/// Size of input SEED for derivation, bytes
static const unsigned long SR25519_SEED_SIZE = 32;

/// Size of SR25519 SIGNATURE, bytes
static const unsigned long SR25519_SIGNATURE_SIZE = 64;

/// Size of VRF output, bytes
static const unsigned long SR25519_VRF_OUTPUT_SIZE = 32;

/// Size of VRF proof, bytes
static const unsigned long SR25519_VRF_PROOF_SIZE = 64;

/// Size of VRF raw output, bytes
static const unsigned long SR25519_VRF_RAW_OUTPUT_SIZE = 16;

/// Size of VRF limit, bytes
static const unsigned long SR25519_VRF_THRESHOLD_SIZE = 16;

enum class Sr25519SignatureResult {
  Ok,
  EquationFalse,
...
/// * secret_ptr: generation seed - input buffer of SR25519_SECRET_SIZE bytes
///
void sr25519_to_ed25519_bytes(uint8_t *secret_out, const uint8_t *secret_ptr);
